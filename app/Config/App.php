...
class App extends BaseConfig
{
   ...
   */
  public string $sessionCookieName = 'cmsql_session';
   ...
   */
  public string $sessionSavePath = 'cmsql_sessions';
   ...
   */
  public string $cookiePrefix = 'cmsql_';
   ...
   */
  public string $CSRFTokenName = 'cmsql_csrf_token';
   ...
   */
  public string $CSRFCookieName = 'cmsql_csrf_cookie';
